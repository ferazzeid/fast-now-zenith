            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Button
                  ...
                  className="w-full h-12 flex items-center justify-center border-2 border-dashed border-primary/30 hover:border-primary/50 bg-background/50"
                >
                  <Lightbulb className="w-5 h-5 mr-2 text-primary" />
                  <span className="text-primary font-medium">Custom Motivator Ideas</span>
                </Button>
              </TooltipTrigger>
              <TooltipContent>
