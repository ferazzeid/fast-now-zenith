      ...
      footer={
        <>
          <Button
            ...
            className="w-full bg-ceramic-base border border-subtle"
          >
            Cancel
          </Button>
          <Button
      ...
      <div data-modal-editing="true" className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            className="bg-ceramic-base border border-subtle"
        ...
        <div className="space-y-2">
          ...
          <Textarea
            ...
            className="bg-ceramic-base border border-subtle min-h-[80px]"
