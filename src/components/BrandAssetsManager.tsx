    ...
    <div className="space-y-6">
      ...
      <Card className="mt-6">
        ...
        <CardContent className="space-y-6">
              ...
              <div className="flex-1 space-y-2">
                <div className="flex gap-2">
                  ...
                  <label
                    ...
                    className={`flex items-center space-x-2 px-4 py-2 border border-dashed border-subtle rounded-lg cursor-pointer hover:bg-accent transition-colors flex-1 ${isUploading ? 'opacity-50 cursor-not-allowed' : ''}`}
                  >
          ...
          <div className="space-y-2">
            <Label>Preview</Label>
            <div className="flex items-center space-x-3 p-3 border border-subtle rounded-lg bg-muted/30">
