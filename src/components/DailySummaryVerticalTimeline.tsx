...
import { Calendar, TrendingDown, Flame, AlertTriangle } from "lucide-react";
...
export const DailySummaryVerticalTimeline = ({ 
  ...
  const handleEndJourney = async () => {
    try {
      ...
      toast({
        title: "Error",
        description: "Failed to end journey. Please try again.",
        variant: "destructive",
      });
    }
  };
      ...
      <CardHeader>
        ...
        <div className="flex items-center justify-between">
          ...
          <AlertDialog>
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                <AlertDialogTitle>End Journey</AlertDialogTitle>
                <AlertDialogDescription>
                  Are you sure you want to end your current 90-day journey? This action cannot be undone.
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
                <AlertDialogCancel>Cancel</AlertDialogCancel>
                <AlertDialogAction onClick={handleEndJourney} disabled={isEndingJourney}>
                  {isEndingJourney ? "Ending..." : "End Journey"}
                </AlertDialogAction>
              </AlertDialogFooter>
            </AlertDialogContent>
          </AlertDialog>
