  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        "action-primary": "bg-primary text-primary-foreground hover:bg-primary/90 text-sm font-medium shadow-sm border border-transparent",
        // ✅ SECONDARY ACTIONS: Supporting actions (Pause, Cancel, etc.) - SAME STYLING AS PRIMARY
        "action-secondary": "bg-primary text-primary-foreground hover:bg-primary/90 text-sm font-medium shadow-sm border border-transparent",
        // ✅ COMPACT ACTIONS: Smaller buttons with same primary styling
        "action-compact": "bg-primary text-primary-foreground hover:bg-primary/90 text-sm font-medium shadow-sm border border-transparent",
        // ✅ AI ACTIONS: Special AI-related buttons (Generate AI Image, Voice Input, etc.) - Now using primary
        "ai": "bg-primary text-primary-foreground hover:bg-primary/90 text-sm font-medium shadow-sm border border-transparent",
      },
      size: {
