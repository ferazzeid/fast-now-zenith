-- Phase 2: Database Cleanup Migration (Simplified)
-- Clean up access system without recreating enums

-- Add 'user' to existing access_level enum in a separate transaction block
DO $$
BEGIN
...
-- Now in a separate block, update the data
DO $$
BEGIN
